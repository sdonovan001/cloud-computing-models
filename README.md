...
The image above illustrates the different application stack responsibilities for each of the hosting models. As you progress from the left to the right (On-Prem -> SaaS), your responsibilities decrease and the cloud providers responsibilites increase. When comparing cloud hosting models, you typically look at five different dimensions: responsibilities, flexibility, operational load, staffing needs and finally total cost of ownership (TCO). 
